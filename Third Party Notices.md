...
**File:** `Samples/TestScene/UI/Resources/CossetteTitre-Regular.ttf`
**License:** SIL Open Font License, Version 1.1
**Full license text:** `Samples/TestScene/UI/Resources/OFL.txt` (distributed alongside the font, as OFL requires)
...
Used as the default typeface for the `MidiStatusDrawer` overlay in the Test Scene
sample. It is loaded by name via `Resources.Load<Font>`, so removing it degrades
gracefully to a dynamic OS font — see `MidiStatusDrawer.UiFont`.
