...
- **Pad Rotation** *(Radial only)* — rotates the pad rings about the centre, default -45 (counter-clockwise; y grows downward so negative is CCW). Pads only — the knob / fader / toggle bands stay keyed to their channel angles. Runtime equivalent: `RadialPadRotation`.
